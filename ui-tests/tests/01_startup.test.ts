/*
 * 01_startup — verify the editor displays correctly on startup.
 *
 * Checks:
 *  - No-file startup shows [No File] in the title bar and status bar
 *  - Status bar shows EDIT mode
 *  - Empty-buffer rows show the ~ tilde marker
